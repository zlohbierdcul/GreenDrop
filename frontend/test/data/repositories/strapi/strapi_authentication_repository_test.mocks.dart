...
// in greendrop/test/data/repositories/strapi/strapi_authentication_repository_test.dart.
...
/// A class which mocks [StrapiAPI].
///
/// See the documentation for Mockito's code generation for more information.
class MockStrapiAPI extends _i1.Mock implements _i10.StrapiAPI {
  MockStrapiAPI() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  String getShops() => (super.noSuchMethod(
        Invocation.method(
          #getShops,
          [],
        ),
  ...
  @override
  String getProductsOfShopById(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getProductsOfShopById,
          [id],
        ),
        returnValue: _i11.dummyValue<String>(
          this,
  ...
  @override
  String getDrugFromId(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getDrugFromId,
          [id],
        ),
  ...
  @override
  String getSignIn() => (super.noSuchMethod(
        Invocation.method(
          #getSignIn,
          [],
        ),
  ...
  @override
  String getUser(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getUser,
          [id],
        ),
  ...
  @override
  String updateUser(_i12.User? user) => (super.noSuchMethod(
        Invocation.method(
          #updateUser,
          [user],
        ),
  ...
  @override
  String updateAddress(_i13.Address? address) => (super.noSuchMethod(
        Invocation.method(
          #updateAddress,
          [address],
        ),
  ...
  @override
  String addAddress() => (super.noSuchMethod(
        Invocation.method(
          #addAddress,
          [],
        ),
  ...
  @override
  String deleteAddress(_i13.Address? address) => (super.noSuchMethod(
        Invocation.method(
          #deleteAddress,
          [address],
        ),
  ...
  @override
  String connectAddressToUser(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #connectAddressToUser,
          [userId],
        ),
        returnValue: _i11.dummyValue<String>(
          this,
  ...
  @override
  String createOrder() => (super.noSuchMethod(
        Invocation.method(
          #createOrder,
          [],
        ),
  ...
  @override
  String createOrderItem() => (super.noSuchMethod(
        Invocation.method(
          #createOrderItem,
          [],
        ),
  ...
  @override
  String getUserOrdersBase(dynamic userId) => (super.noSuchMethod(
        Invocation.method(
          #getUserOrdersBase,
          [userId],
        ),
  ...
  @override
  String getUserOrdersItems(dynamic userId) => (super.noSuchMethod(
        Invocation.method(
          #getUserOrdersItems,
          [userId],
        ),
  ...
  @override
  String getShopById(dynamic id) => (super.noSuchMethod(
        Invocation.method(
          #getShopById,
          [id],
        ),
  ...
  @override
  String getAddressById(dynamic id) => (super.noSuchMethod(
        Invocation.method(
          #getAddressById,
          [id],
        ),
  ...
  @override
  String getUserOrders(dynamic userId) => (super.noSuchMethod(
        Invocation.method(
          #getUserOrders,
          [userId],
        ),
  ...
  @override
  String getRegister() => (super.noSuchMethod(
        Invocation.method(
          #getRegister,
          [],
        ),
  ...
  @override
  String createAddress() => (super.noSuchMethod(
        Invocation.method(
          #createAddress,
          [],
        ),
  ...
  @override
  String createUserDetail() => (super.noSuchMethod(
        Invocation.method(
          #createUserDetail,
          [],
        ),
  ...
  @override
  String connectUserDetail(dynamic userId) => (super.noSuchMethod(
        Invocation.method(
          #connectUserDetail,
          [userId],
        ),
