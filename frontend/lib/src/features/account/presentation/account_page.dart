...
class AccountPage extends StatelessWidget {
  ...
  Account _createAccountFromControllers(String id) {
    return Account(
      ...
      houseNumber: double.tryParse(_houseNumberController.text) ?? 0,
      plz: double.tryParse(_plzController.text) ?? 0,
                            ...
                            children: [
                              ...
                              FilledButton(
                                onPressed: () async {
                                  ...
                                  if (accountId != null) {
                                    accountProvider.updateAccount(_createAccountFromControllers(accountId));
                                    await accountProvider.saveAccountData(context);
